...
fn consecutive_strikes_each_get_the_two_roll_bonus() {
    ...
    let _ = game.roll(10); // .   (1, 1) -> (2, 2)
    let _ = game.roll(10); // ..  (2, 2) -> (3, 2)
    let _ = game.roll(10); // ... (3, 2) -> (3, 2)
    let _ = game.roll(5); // ... (3, 2) -> (2, 1)
    let _ = game.roll(3); // ..  (2, 1) -> (1, 1)
